	  ...
	  [ div(class(card), div(class('card-body'),
		...
		p(class('card-text'),
		  [ "“Laparoscopy-naïve medical students were randomized into ",
		    ...
		    \mmlm([task(tgroups2), round(0)], N_BOX = r(n_box)), ") used E-learning for ", 
		    "laparoscopic cholecystectomy and practiced ",
		    "basic skills with Box trainers. The VR group (", 
		    \mmlm([task(tgroups2), round(0)], N_VR = r(n_vr)), ") trained ",
		    ...
		    "(VR: ", \mmlm([task(tgroups2), round(1)], r(vr)), " ± ", \mmlm([task(tgroups2), round(1)], r(s_vr)), 
		    " vs. BOX: ", \mmlm([task(tgroups2), round(1)], r(box)), " ± ", \mmlm([task(tgroups2), round(1)], r(s_box)), 
